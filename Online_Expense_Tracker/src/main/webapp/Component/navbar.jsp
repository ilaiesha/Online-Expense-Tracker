    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <c:if test="${not empty loginUser}">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="view_expense.jsp"><i class="fa-solid fa-list"></i> View Expense</a>
          </li>
        </c:if>
      </ul>
      ...
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        <c:if test="${not empty loginUser}">
          <li class="nav-item">
            <a class="nav-link active" href="#"><i class="fa-solid fa-user"></i> ${loginUser.fullname}</a>
          </li>
          <li class="nav-item">
