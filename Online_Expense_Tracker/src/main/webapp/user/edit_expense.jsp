...
<%@page import="com.dataAccessObject.ExpenseDao"%>
             ...
             <div class="row">
                  <div class="col-md-4 offset-md-4">
                      <div class="card card-sh">
                          ...
                          <div class="mb-3">
                             <label>Time</label> <input type="date" name="time" class="form-control" value="<%=ex.getTime()%>">
                          </div>
                         ...
                         <div class="mb-3">
                             <label>Price</label> <input type="text" name="price" class="form-control"value="<%=ex.getPrice()%>">
                          </div>
